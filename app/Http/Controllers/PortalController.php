...
class PortalController extends Controller
{
 ...
 private function teacherSessions(int $userId){return TrainingSession::with(['group.plan.course','group.enrollments.student','classroom:id,name','attendances'])->where('teacher_id',$userId)->orderBy('starts_at')->get();}
