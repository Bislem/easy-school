...
class SubjectsController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        $subjects = Course::query()->with(['schoolLevels.cycle:id,name', 'teachers:id,name,email'])->withCount('timetableSessions')
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        DB::transaction(function () use ($data) {
            ...
            $subject = Course::create([...$data, 'duration_hours' => max(1, (int) ceil((float) $data['weekly_hours'])), 'price' => 0, 'is_certified' => false]);
            $subject->schoolLevels()->sync($levels);
    ...
    public function update(Request $request, Course $subject): RedirectResponse
    {
    ...
    public function destroy(Course $subject): RedirectResponse
    {
    ...
    public function toggle(Course $subject): RedirectResponse
    {
    ...
    private function validated(Request $request, ?Course $subject = null): array
    {
        return $request->validate([
            'title' => ['required', 'string', 'max:150'], 'code' => ['required', 'string', 'max:50', TenantRule::unique('courses', 'code')->ignore($subject)],
