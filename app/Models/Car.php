...
class Car extends Model
{
    ...
    public function getImageUrlAttribute(): string
    {
        ...
        if ($file && $file->path) {
            if(str_contains($file->path,'storage/')){
                return Storage::url(str_replace('storage/','',$file->path));
            }
    ...
    /** Historical fuel tank readings for this car. */
    public function fuelTankRecords(): HasMany
    {
        return $this->hasMany(FuelTankRecord::class);
    }

    /** All costs recorded against this vehicle, including maintenance. */
