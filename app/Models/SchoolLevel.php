...
class SchoolLevel extends Model
{
    ...
    {
        $relation = $this->belongsToMany(SchoolSubject::class, 'course_school_level', 'school_level_id', 'course_id')->withPivot(['school_stream_id', 'curriculum_code', 'is_optional', 'is_active', 'display_order', 'choice_group', 'coefficient'])->withTimestamps();
