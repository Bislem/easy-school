...
class Reservation extends Model
{
    ...
    protected $casts = [
        ...
        'required_advance_amount' => 'decimal:2',
    ...
    public function requestedDriver(): BelongsTo
    {
        return $this->belongsTo(Driver::class, 'requested_driver_id');
    }
    ...
    /** Fuel tank readings recorded when this rental starts and ends. */
    public function fuelTankRecords(): HasMany
    {
        return $this->hasMany(FuelTankRecord::class);
    }
