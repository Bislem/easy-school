...
class TimetableSession extends Model
{
    ...
    protected $fillable = ['academic_year_id', 'school_group_id', 'course_id', 'teacher_id', 'classroom_id', 'academic_period_id', 'series_id', 'parent_session_id', 'day', 'effective_date', 'start_time', 'end_time', 'recurrence', 'change_type', 'notes', 'status'];

    protected function casts(): array
    {
        return ['day' => 'integer', 'effective_date' => 'date:Y-m-d', 'recurrence' => TimetableRecurrence::class, 'status' => TimetableSessionStatus::class];
    }
