...
const modalConfig = computed<{
    ...
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'L’authentification à deux facteurs est activée. Scannez le code QR ou saisissez la clé dans votre application d’authentification.',
            buttonText: 'Fermer',
        };
    }
    ...
    return {
        ...
        description:
            'Pour terminer, scannez le code QR ou saisissez la clé dans votre application d’authentification',
        buttonText: 'Continuer',
    };
});
