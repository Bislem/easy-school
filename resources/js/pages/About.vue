                ...
                <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    <div class="text-center">
                        <h1 class="mb-6 text-4xl font-bold md:text-5xl">
                            À propos de Real Rent Car
                        </h1>
                        <p class="mx-auto max-w-3xl text-xl leading-relaxed text-gray-300">
                            Votre partenaire de confiance pour des services de location de voitures haut de gamme,

                            fournissant des solutions de transport fiables depuis
            ...
            <div class="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
                    ...
                    <div class="grid items-center gap-12 lg:grid-cols-2">
                        <div>
                            ...
                            <div class="space-y-4 leading-relaxed text-gray-600">
                                <p>
                                    Fondée en 2015, Real Rent Car a débuté avec une

                                    mission simple : fournir des services de location de voitures fiables,

                                    abordables et pratiques
                                    aux voyageurs comme aux locaux. Ce qui
                                    a commencé avec une petite flotte de 10 véhicules est devenu
                                    un service de location complet

                                    avec plus de 200 véhicules haut de gamme.
                                </p>
                                <p>
                                    Nous savons que chaque déplacement est

                                    important, qu'il s'agisse d'un voyage d'affaires,

                                    de vacances en famille ou des trajets quotidiens. C'est

                                    pourquoi nous avons bâti notre réputation sur la confiance,

                                    la qualité et un service client exceptionnel.
                                </p>
                            </div>
                        </div>
                ...
                <div class="mb-20">
                    <div class="mb-12 text-center">
                        ...
                        <p class="mx-auto max-w-2xl text-gray-600">
                            Nous nous engageons à offrir des expériences de location de voitures exceptionnelles

                            tout en maintenant les normes les plus élevées

                            de service et d'intégrité.
                        </p>
                    </div>
                    ...
                    <div class="grid gap-8 md:grid-cols-3">
                        <div class="p-6 text-center">
                            <div
                                ...
                                <svg class="h-8 w-8 fill-white" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 640 640">
                                    <path
                            ...
                            <p class="text-gray-600">
                                Chaque véhicule de notre flotte est régulièrement
                                entretenu et inspecté afin de garantir votre sécurité

                                et votre tranquillité d'esprit à chaque trajet.
                            </p>
                        </div>
                        ...
                        <div class="p-6 text-center">
                            ...
                            <p class="text-gray-600">
                                Pas de frais cachés, pas de mauvaises surprises. Nous croyons en une tarification claire
                                et transparente et à une communication honnête
                        ...
                        <div class="p-6 text-center">
                            ...
                            <p class="text-gray-600">
                                Nous nous efforçons constamment de dépasser les attentes

                                grâce à un service de qualité supérieure, des véhicules de qualité et
                ...
                <div class="mb-20">
                    <div class="rounded-lg bg-gray-50 p-8 md:p-12">
                        <h2 class="mb-8 text-center text-3xl font-bold text-gray-900">
                            Pourquoi choisir Ease Rent Car ?
                        </h2>

                        <div class="grid gap-8 md:grid-cols-2">
                            <div class="space-y-6">
                                <div class="flex items-start space-x-4">
                                    <svg class="h-8 w-8 fill-orange-500" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 640 640">
                                        <path
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Service client disponible 24h/24 et 7j/7 et
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Réservation en ligne facile avec des options de prise en charge et de retour
                                            flexibles.

                                            Options de prise en charge et de retour
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Les meilleurs tarifs du marché, sans
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Points de ramassage pratiques dans toute la
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Tous les véhicules font l'objet de contrôles de sécurité rigoureux.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="mb-20">
                    <div class="mb-12 text-center">
                        ...
                        <p class="mx-auto max-w-2xl text-gray-600">
                            Découvrez les professionnels expérimentés qui font progresser notre
                            entreprise et assurent un service exceptionnel à
                            chaque client.
                        </p>
                    </div>
                    ...
                    <div class="grid gap-8 md:grid-cols-3">
                        <div class="text-center">
                            <img class="mx-auto mb-4 h-32 w-32 overflow-hidden rounded-full bg-gray-200 object-cover"
                                src="images/team/sara.webp" alt="" />
                            ...
                            <p class="text-sm text-gray-600">
                                Plus de 15 ans d'expérience dans l'industrie automobile, avec une passion pour
                        ...
                        <div class="text-center">
                            <img class="mx-auto mb-4 h-32 w-32 overflow-hidden rounded-full bg-gray-200 object-cover"
                                src="images/team/michael.webp" alt="" />
                            <h4 class="mb-1 text-xl font-semibold text-gray-900">
                                Michael Chen
                            </h4>
                            <p class="mb-2 font-medium text-orange-500">
                            ...
                            <p class="text-sm text-gray-600">
                                Expert en gestion de flottes et logistique avec 12
                        ...
                        <div class="text-center">
                            <img class="mx-auto mb-4 h-32 w-32 overflow-hidden rounded-full bg-gray-200 object-cover"
                                src="images/team/emily.webp" alt="" />
                            <h4 class="mb-1 text-xl font-semibold text-gray-900">
                                Emily Rodriguez
                            </h4>
                            <p class="mb-2 font-medium text-orange-500">
                            ...
                            <p class="text-sm text-gray-600">
                                Nous nous engageons à garantir à chaque client une
                ...
                <div class="rounded-lg bg-gray-900 p-8 text-center text-white md:p-12">
                    <h2 class="mb-4 text-3xl font-bold">
                        Prêt à commencer ?
                    </h2>
                    <p class="mx-auto mb-8 max-w-2xl text-gray-300">
                        Découvrez la différence Real Rent Car dès aujourd'hui. Parcourez
                        notre flotte et réservez le véhicule idéal en quelques
                        clics.
                    </p>
                    <div class="flex flex-col justify-center gap-4 sm:flex-row">
                        <a :href="fleet.url()"
                            ...
                            Parcourez notre sélection de véhicules
                        </a>
                        <a :href="contact.url()"
