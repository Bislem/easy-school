...
import { contact, fleet } from '@/routes';
</script>
<template>
    <HomeLayout>
                ...
                <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    <div class="text-center">
                        ...
                        >
                            ...
                            location de voitures haut de gamme, fournissant des
                            solutions de transport fiables depuis 2015.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
                <div class="mb-20">
                    <div class="grid items-center gap-12 lg:grid-cols-2">
                        <div>
                            ...
                            >
                                <p>
                                    Fondée en 2015, Real Rent Car a débuté avec
                                    une mission simple : fournir des services de
                                    location de voitures fiables, abordables et
                                    pratiques aux voyageurs comme aux locaux. Ce
                                    qui a commencé avec une petite flotte de 10
                                    véhicules est devenu un service de location
                                    complet avec plus de 200 véhicules haut de
                                    gamme.
                                </p>
                                <p>
                                    Nous savons que chaque déplacement est
                                    important, qu'il s'agisse d'un voyage
                                    d'affaires, de vacances en famille ou des
                                    trajets quotidiens. C'est pourquoi nous
                                    avons bâti notre réputation sur la
                                    confiance, la qualité et un service client
                                    exceptionnel.
                                </p>
                            </div>
                        </div>
                ...
                <div class="mb-20">
                    <div class="mb-12 text-center">
                        ...
                        <p class="mx-auto max-w-2xl text-gray-600">
                            Nous nous engageons à offrir des expériences de
                            location de voitures exceptionnelles tout en
                            maintenant les normes les plus élevées de service et
                            d'intégrité.
                        </p>
                    </div>
                    ...
                    <div class="grid gap-8 md:grid-cols-3">
                        <div class="p-6 text-center">
                            ...
                            <p class="text-gray-600">
                                Chaque véhicule de notre flotte est
                                régulièrement entretenu et inspecté afin de
                                garantir votre sécurité et votre tranquillité
                                d'esprit à chaque trajet.
                            </p>
                        </div>
                        ...
                        <div class="p-6 text-center">
                            ...
                            <p class="text-gray-600">
                                ...
                                Nous croyons en une tarification claire et
                                transparente et à une communication honnête avec
                                tous nos clients.
                            </p>
                        </div>
                        ...
                        <div class="p-6 text-center">
                            ...
                            <p class="text-gray-600">
                                Nous nous efforçons constamment de dépasser les
                                attentes grâce à un service de qualité
                                supérieure, des véhicules de qualité et des
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Véhicules modernes et bien
                                            entretenus de constructeurs de renom
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Réservation en ligne facile avec des
                                            options de prise en charge et de
                                            retour flexibles. Options de prise
                                            en charge et de retour
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Points de ramassage pratiques dans
                                            toute la ville
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            Tous les véhicules font l'objet de
                ...
                <div class="mb-20">
                    <div class="mb-12 text-center">
                        ...
                        <p class="mx-auto max-w-2xl text-gray-600">
                            Découvrez les professionnels expérimentés qui font
                            progresser notre entreprise et assurent un service
                    ...
                    <div class="grid gap-8 md:grid-cols-3">
                        <div class="text-center">
                            ...
                            <p class="text-sm text-gray-600">
                                ...
                                automobile, avec une passion pour l'excellence
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-sm text-gray-600">
                                Expert en gestion de flottes et logistique avec
                                12 ans d'expérience dans le secteur.
                            </p>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-sm text-gray-600">
                                Nous nous engageons à garantir à chaque client
                                une expérience de location exceptionnelle.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                >
                    <h2 class="mb-4 text-3xl font-bold">Prêt à commencer ?</h2>
                    <p class="mx-auto mb-8 max-w-2xl text-gray-300">
                        Découvrez la différence Real Rent Car dès aujourd'hui.
                        Parcourez notre flotte et réservez le véhicule idéal en
                        quelques clics.
                    </p>
