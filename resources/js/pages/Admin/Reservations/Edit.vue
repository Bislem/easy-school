    ...
    <AdminLayout>
        <main class="flex-1 space-y-6 p-8">
            <div class="flex items-center justify-between gap-4">
                <h1 class="text-2xl font-semibold">Modifier la réservation</h1>
                <Link :href="index().url">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div class="rounded-md border p-4">
                    <div class="text-sm text-muted-foreground">Véhicule</div>
                    <div class="font-medium">
                        {{
                            reservation.car
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        <Label for="pickup_time"
                            >Heure de prise en charge</Label
                        >
                        <Input
                            id="pickup_time"
                    ...
                    >
                        ...
                        <textarea
                            ...
                            rows="3"
                            class="w-full rounded-md border border-input bg-transparent px-3 py-2"
                            placeholder="Pourquoi cette réservation a-t-elle été annulée ?"
                        ></textarea>
                        <InputError
