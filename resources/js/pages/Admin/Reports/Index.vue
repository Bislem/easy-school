                ...
                tooltip: {
                    ...
                    callbacks: {
                        ...
                        afterBody: function (tooltipItems) {
                            ...
                            return [``, `Total des réservations : ${total}`];
                        },
    ...
    <AdminLayout>
        <div class="space-y-6 px-8 py-4">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div class="rounded-lg border-l-4 border-red-500 bg-white p-5 shadow">
                    <p class="text-sm font-medium text-gray-500">{{ kpis.totalExpenses.label }}</p>
                    <p class="mt-1 text-2xl font-semibold text-red-600">{{ kpis.totalExpenses.formatted }}</p>
                    <p class="mt-1 text-xs text-gray-500">Frais d'agence et entretiens sur la période</p>
                </div>
                <div class="rounded-lg border-l-4 bg-white p-5 shadow" :class="kpis.netProfit.value >= 0 ? 'border-emerald-500' : 'border-red-500'">
                    <p class="text-sm font-medium text-gray-500">{{ kpis.netProfit.label }}</p>
                    <p class="mt-1 text-2xl font-semibold" :class="kpis.netProfit.value >= 0 ? 'text-emerald-600' : 'text-red-600'">{{ kpis.netProfit.formatted }}</p>
                    <p class="mt-1 text-xs text-gray-500">Revenus encaissés moins toutes les dépenses</p>
                </div>
            </div>
            ...
            <div class="rounded-lg bg-white shadow">
                <div class="p-6">
                    <div class="mb-4 flex items-center justify-between">
                        <h3 class="text-lg font-medium text-gray-900">
                            Top 10 des performances des véhicules
                        </h3>
                        <div class="text-sm text-gray-500">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="cursor-pointer px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase hover:bg-gray-100" @click="sortTable('total_expenses')">Dépenses</th>
                                    <th scope="col" class="cursor-pointer px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase hover:bg-gray-100" @click="sortTable('net_profit')">Résultat net</th>
                                    <th
                                        scope="col"
                                        class="cursor-pointer px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase hover:bg-gray-100"
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 text-sm whitespace-nowrap text-red-600">{{ car.formatted_expenses }}</td>
                                    <td class="px-6 py-4 text-sm font-medium whitespace-nowrap" :class="car.net_profit >= 0 ? 'text-emerald-600' : 'text-red-600'">{{ car.formatted_net_profit }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div
                                    ...
                                    >
                                        {{
                                            car.average_per_reservation > 0
                                                ? `${car.average_per_reservation.toFixed(2)} DZD`
                                                : '0.00 DZD'
                                        }}
                                    </td>
                                </tr>
