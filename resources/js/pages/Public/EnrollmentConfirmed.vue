...
<template>
    ...
    >
        <div
            class="w-full max-w-lg rounded-2xl border bg-white p-7 text-center shadow-sm sm:p-10"
        >
            ...
            <p class="mt-6 text-sm text-slate-500">
                L'établissement vous contactera avec les prochaines
                informations.
            </p>
        </div>
    </main>
