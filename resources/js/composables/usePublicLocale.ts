...
const en: Record<string, string> = {
    ...
    'Créer votre école': 'Create Your School',
    'Créer mon école': 'Create My School',
    'Créer votre école.': 'Create your school.',
    'Commencez immédiatement.': 'Start immediately.',
    '30 jours gratuits, sans paiement': '30 days free, no payment required',
    'Ouvrez votre espace Easy School et accédez à toutes les fonctions essentielles pendant 30 jours. Aucun plan ni justificatif de paiement demandé.':
        'Open your Easy School workspace and access all essential features for 30 days. No plan or payment proof required.',
    'Activation immédiate': 'Immediate activation',
    'Données isolées et sécurisées': 'Secure, isolated data',
    "Vos données restent conservées après l'essai":
        'Your data remains safely stored after the trial',
    'Seulement les informations nécessaires pour démarrer.':
        'Only the information needed to get started.',
    ...
    'Paiements scolaires': 'School Payments',
    'Comptes financiers individuels, échéances et encaissements.':
        'Individual financial accounts, installments and collections.',
    'Structure tarifaire': 'Fee structure',
    'Générer les frais élèves': 'Generate Student Fees',
    'Total attendu': 'Total expected',
    Encaissé: 'Collected',
    Restant: 'Outstanding',
    'En retard': 'Overdue',
    Taux: 'Collection rate',
    'Élèves débiteurs': 'Students with unpaid balances',
    Niveau: 'Level',
    Groupe: 'Group',
    Attendu: 'Expected',
    Payé: 'Paid',
    ...
    Statut: 'Status',
    Ouvrir: 'Open',
    'Nouvelle structure tarifaire': 'New fee structure',
    Composants: 'Components',
    'Échéancier libre': 'Custom schedule',
    Obligatoire: 'Mandatory',
    'Compte financier': 'Financial account',
    'Total payé': 'Total paid',
    Échéancier: 'Installment schedule',
    'Historique auditable': 'Auditable history',
    Encaisser: 'Record payment',
    Mouvement: 'Adjustment',
    'Paiements formations': 'Formation Payments',
    'Facturation indépendante par inscription, session et formation.':
        'Independent billing for each enrollment, session, and formation.',
    Tarification: 'Pricing',
    'Générer la facturation': 'Generate Billing',
    Exporter: 'Export',
    'Revenu attendu': 'Expected revenue',
    ...
    'Tarification formation/session': 'Formation/session pricing',
    'Échéancier personnalisé': 'Custom payment schedule',
    'Toutes les formations': 'All formations',
    'Toutes les sessions': 'All sessions',
    'Tous les étudiants': 'All students',
    'Compte formation': 'Formation account',
    'Remise / ajustement': 'Discount / adjustment',
    'Échéancier attendu': 'Expected installments',
    'Historique des transactions': 'Transaction history',
    'Paiement formation': 'Formation payment',
    'Structures tarifaires': 'Fee structures',
    'Barèmes disponibles pour l’année scolaire sélectionnée.':
        'Fee structures available for the selected academic year.',
    'Nouvelle structure': 'New structure',
    Échéances: 'Installments',
    'Utiliser cette structure': 'Use this structure',
    'Aucune structure tarifaire pour cette année.':
        'No fee structure exists for this academic year.',
    'Créez d’abord une structure avant de générer les frais des élèves.':
        'Create a structure before generating student fees.',
    'Filtres des comptes': 'Account filters',
    'Affinez les résultats par contexte scolaire.':
        'Refine results by school context.',
    Réinitialiser: 'Reset',
    'Niveau et spécialité': 'Grade and specialization',
    'Statut de paiement': 'Payment status',
    'Élève précis': 'Specific student',
    'Tous les groupes': 'All groups',
    'Tous les sites': 'All sites',
    'Tous les statuts': 'All statuses',
    'Aucune facturation générée.': 'No billing has been generated.',
    'Toutes sessions': 'All sessions',
    'Tous groupes': 'All groups',
    'Nom de la tarification': 'Pricing name',
    'Prix total DZD': 'Total price in DZD',
    Ajouter: 'Add',
    Enregistrer: 'Save',
    'Toutes sessions applicables': 'All applicable sessions',
    'Mettre à jour les comptes sans transaction':
        'Update accounts without transactions',
    'Calculer les inscriptions concernées': 'Preview affected enrollments',
    'Confirmer la génération': 'Confirm generation',
    'Sans groupe': 'No group',
    'Mouvement financier': 'Financial adjustment',
    Montant: 'Amount',
    'Référence bancaire / CCP': 'Bank / CCP reference',
    'Notes du paiement': 'Payment notes',
    'Remise formation': 'Formation discount',
    ...
    Méthode: 'Method',
    Paiements: 'Payments',
    'Vue d’ensemble des paiements': 'Payments Overview',
    'Centre de contrôle financier scolaire et formation.':
        'Financial control center for school and formation billing.',
    'Toutes les sources': 'All sources',
    Scolaire: 'School',
    SCOLAIRE: 'SCHOOL',
    'Toutes les années scolaires': 'All academic years',
    'Tous les niveaux': 'All levels',
    'Tous les modes de paiement': 'All payment methods',
    'Appliquer les filtres': 'Apply filters',
    'Total encaissé': 'Total collected',
    'Encaissements mensuels': 'Monthly collections',
    'Encaissements quotidiens': 'Daily collections',
    'Répartition par mode de paiement': 'Payment method distribution',
    'Transactions récentes': 'Recent transactions',
    Contexte: 'Context',
    'Enregistré par': 'Recorded by',
    'Aucune transaction pour cette période.':
        'No transactions for this period.',
    'Paiements en attente': 'Outstanding payments',
    'Échéance la plus proche': 'Nearest due date',
    'Montant restant décroissant': 'Highest remaining amount',
    'Date d’échéance': 'Due date',
    'Aucun paiement en attente.': 'No outstanding payments.',
    Démo: 'Demo',
...
const ar: Record<string, string> = {
    ...
    'Créer votre école': 'أنشئ مدرستك',
    'Créer mon école': 'إنشاء مدرستي',
    'Créer votre école.': 'أنشئ مدرستك.',
    'Commencez immédiatement.': 'وابدأ فوراً.',
    '30 jours gratuits, sans paiement': '30 يوماً مجاناً دون دفع',
    'Ouvrez votre espace Easy School et accédez à toutes les fonctions essentielles pendant 30 jours. Aucun plan ni justificatif de paiement demandé.':
        'افتح مساحة مدرستك واستفد من الوظائف الأساسية لمدة 30 يوماً، دون اختيار باقة أو تقديم إثبات دفع.',
    'Activation immédiate': 'تفعيل فوري',
    'Données isolées et sécurisées': 'بيانات معزولة وآمنة',
    "Vos données restent conservées après l'essai":
        'تبقى بياناتك محفوظة بأمان بعد انتهاء التجربة',
    'Seulement les informations nécessaires pour démarrer.':
        'المعلومات الضرورية فقط للبدء.',
    "Nom de l'école *": 'اسم المدرسة *',
    "Type d'établissement *": 'نوع المؤسسة *',
    "Nom de l'administrateur *": 'اسم المسؤول *',
    'Adresse e-mail *': 'البريد الإلكتروني *',
    'Mot de passe *': 'كلمة المرور *',
    'Confirmation *': 'تأكيد كلمة المرور *',
    'Paiements scolaires': 'المدفوعات المدرسية',
    'Comptes financiers individuels, échéances et encaissements.':
        'حسابات مالية فردية وأقساط وتحصيلات.',
    'Structure tarifaire': 'هيكل الرسوم',
    'Générer les frais élèves': 'إنشاء رسوم التلاميذ',
    'Total attendu': 'الإجمالي المتوقع',
    Encaissé: 'المحصّل',
    Restant: 'المتبقي',
    'En retard': 'متأخر',
    Taux: 'نسبة التحصيل',
    'Élèves débiteurs': 'التلاميذ ذوو الرصيد غير المدفوع',
    Niveau: 'المستوى',
    Groupe: 'القسم',
    Attendu: 'المتوقع',
    Payé: 'المدفوع',
    'Prochaine échéance': 'القسط القادم',
    Statut: 'الحالة',
    Ouvrir: 'فتح',
    'Nouvelle structure tarifaire': 'هيكل رسوم جديد',
    Composants: 'المكونات',
    'Échéancier libre': 'جدول أقساط مخصص',
    Obligatoire: 'إلزامي',
    'Compte financier': 'الحساب المالي',
    'Total payé': 'إجمالي المدفوع',
    Échéancier: 'جدول الأقساط',
    'Historique auditable': 'سجل قابل للتدقيق',
    Encaisser: 'تسجيل دفعة',
    Mouvement: 'حركة مالية',
    'Paiements formations': 'مدفوعات التكوين',
    'Facturation indépendante par inscription, session et formation.':
        'فوترة مستقلة لكل تسجيل ودورة وتكوين.',
    Tarification: 'التسعير',
    'Générer la facturation': 'إنشاء الفوترة',
    Exporter: 'تصدير',
    'Revenu attendu': 'الإيراد المتوقع',
    ...
    'Tarification formation/session': 'تسعير التكوين والدورة',
    'Échéancier personnalisé': 'جدول دفع مخصص',
    'Toutes les formations': 'كل التكوينات',
    'Toutes les sessions': 'كل الدورات',
    'Tous les étudiants': 'كل الطلاب',
    'Compte formation': 'حساب التكوين',
    'Remise / ajustement': 'خصم / تسوية',
    'Échéancier attendu': 'الأقساط المتوقعة',
    'Historique des transactions': 'سجل المعاملات',
    'Paiement formation': 'دفع التكوين',
    'Structures tarifaires': 'هياكل الرسوم',
    'Barèmes disponibles pour l’année scolaire sélectionnée.':
        'هياكل الرسوم المتاحة للسنة الدراسية المحددة.',
    'Nouvelle structure': 'هيكل جديد',
    Échéances: 'الأقساط',
    'Utiliser cette structure': 'استخدام هذا الهيكل',
    'Aucune structure tarifaire pour cette année.':
        'لا يوجد هيكل رسوم لهذه السنة الدراسية.',
    'Créez d’abord une structure avant de générer les frais des élèves.':
        'أنشئ هيكل رسوم قبل إنشاء رسوم التلاميذ.',
    'Filtres des comptes': 'عوامل تصفية الحسابات',
    'Affinez les résultats par contexte scolaire.':
        'خصص النتائج حسب السياق المدرسي.',
    Réinitialiser: 'إعادة ضبط',
    'Niveau et spécialité': 'المستوى والتخصص',
    'Statut de paiement': 'حالة الدفع',
    'Élève précis': 'تلميذ محدد',
    'Tous les groupes': 'كل المجموعات',
    'Tous les sites': 'كل الفروع',
    'Tous les statuts': 'كل الحالات',
    'Aucune facturation générée.': 'لم يتم إنشاء أي فوترة.',
    'Toutes sessions': 'كل الدورات',
    'Tous groupes': 'كل المجموعات',
    'Nom de la tarification': 'اسم التسعيرة',
    'Prix total DZD': 'السعر الإجمالي بالدينار',
    Ajouter: 'إضافة',
    Enregistrer: 'حفظ',
    'Toutes sessions applicables': 'كل الدورات المعنية',
    'Mettre à jour les comptes sans transaction':
        'تحديث الحسابات التي لا تحتوي على معاملات',
    'Calculer les inscriptions concernées': 'معاينة التسجيلات المعنية',
    'Confirmer la génération': 'تأكيد الإنشاء',
    'Sans groupe': 'دون مجموعة',
    'Mouvement financier': 'حركة مالية',
    Montant: 'المبلغ',
    'Référence bancaire / CCP': 'مرجع البنك / الحساب البريدي',
    'Notes du paiement': 'ملاحظات الدفع',
    'Remise formation': 'خصم التكوين',
    Exonération: 'إعفاء',
    Ajustement: 'تسوية',
    ...
    Méthode: 'طريقة الدفع',
    Paiements: 'المدفوعات',
    'Vue d’ensemble des paiements': 'نظرة عامة على المدفوعات',
    'Centre de contrôle financier scolaire et formation.':
        'مركز المراقبة المالية للمدرسة والتكوين.',
    'Toutes les sources': 'كل المصادر',
    Scolaire: 'مدرسي',
    SCOLAIRE: 'المدرسة',
    'Toutes les années scolaires': 'كل السنوات الدراسية',
    'Tous les niveaux': 'كل المستويات',
    'Tous les modes de paiement': 'كل طرق الدفع',
    'Appliquer les filtres': 'تطبيق عوامل التصفية',
    'Total encaissé': 'إجمالي المحصل',
    'Encaissements mensuels': 'التحصيلات الشهرية',
    'Encaissements quotidiens': 'التحصيلات اليومية',
    'Répartition par mode de paiement': 'التوزيع حسب طريقة الدفع',
    'Transactions récentes': 'أحدث المعاملات',
    Contexte: 'السياق',
    'Enregistré par': 'سجله',
    'Aucune transaction pour cette période.':
        'لا توجد معاملات خلال هذه الفترة.',
    'Paiements en attente': 'المدفوعات المستحقة',
    'Échéance la plus proche': 'أقرب تاريخ استحقاق',
    'Montant restant décroissant': 'أعلى مبلغ متبقٍ',
    'Date d’échéance': 'تاريخ الاستحقاق',
    'Aucun paiement en attente.': 'لا توجد مدفوعات مستحقة.',
    Démo: 'تجربة',
