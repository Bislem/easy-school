...
Route::middleware(['auth', 'verified', 'active', 'client-access', 'client'])
    ->prefix('client')
    ->as('client.')
    ->group(function () {
        ...
        Route::post('/reservations/{id}/payment-proof', [ReservationsController::class, 'submitPaymentProof'])->name('reservations.payment-proof');
