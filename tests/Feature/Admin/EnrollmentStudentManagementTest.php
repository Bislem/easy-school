...
test('an administrator can add and remove a student from a form', function () {
    ...
    $form = EnrollmentForm::create(['course_id' => $course->id, 'teacher_id' => $teacher->id, 'title' => 'Inscriptions', 'start_date' => now()->addWeek(), 'end_date' => now()->addWeeks(2), 'min_students' => 1, 'max_students' => 10, 'groups_count' => 2, 'is_active' => true]);
